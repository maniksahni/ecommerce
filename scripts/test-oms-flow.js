...
// 2. Validate script.js Guest Checkout
...
assert(scriptContent.includes("customerName: name"), "script.js order payload must contain customerName");
assert(scriptContent.includes("customerPhone: phone"), "script.js order payload must contain customerPhone");
assert(scriptContent.includes("shippingDetails:"), "script.js order payload must contain shippingDetails");
...
console.log("PASS 2: script.js guest checkout persistence and order document schema verified");
